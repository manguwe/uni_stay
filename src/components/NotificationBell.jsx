...
export default function NotificationBell() {
  ...
  return (
    <div className="relative" ref={containerRef}>
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 w-80 max-w-[calc(100vw-3rem)] max-h-96 overflow-y-auto bg-surface border border-border rounded-btn shadow-lg z-50">
