...
const STATUS_GROUPS = [
  { key: 'active', label: 'Active', statuses: ['escalated', 'assigned', 'in_progress'] },
...
export default function PatronDashboard() {
  ...
  const load = useCallback(async () => {
    ...
    setError(null)
    try {
      // RLS already restricts this to complaints escalated_at is not null
      // for the caller's assigned hostel(s) — nothing pre-escalation ever
      // appears here regardless of status filter below.
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl mb-1">Patron/Matron — Complaints</h1>
        <p className="text-body/70 text-sm">
          ...
          · Only complaints escalated by a chairperson appear here.
        </p>
      </div>
